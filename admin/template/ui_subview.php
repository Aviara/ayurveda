...
?>
						...
						<div class="toolbar row">
							<div class="col-sm-6 hidden-xs">
								<div class="page-header">
									<h1>Subview <small>a powerful plugin for show contents</small></h1>
								</div>
							</div>
								...
								<div class="panel panel-white">
									...
									<div class="panel-body">
										...
										<div class="row">
											<div class="col-md-12">
												<div class="col-md-3 col-sm-4 space20">
													<a class="btn btn-green show-sv" href="#example-subview-1">
			...
			<div id="example-subview-1" class="no-display">
				<div class="col-md-8 col-md-offset-2">
					...
					<h3>Popover in Subview</h3>
					<p>
						This
						<a data-content="And here's some amazing content. It's very engaging. right?" title="" class="btn btn-default popovers" role="button" href="#" data-original-title="A Title">
							button
						</a>
						should trigger a popover on click.
					</p>
					<h3>Tooltips in Subview</h3>
					<p>
		...
		<script src="assets/js/ui-subview.js"></script>
...
<!-- Mirrored from www.cliptheme.com/demo/rapido/ui_subview.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 03 Nov 2015 05:10:33 GMT -->
</html>