            ...
            <ul class="main-navigation-menu">
                ...
                <li>
                    <a href="javascript:;" class="active">
                        <i class="fa fa-folder"></i> <span class="title"> Resort Policies </span> <i class="icon-arrow"></i>
                    </a>
                    <ul class="sub-menu">
                        <li>
                ...
                <li>
                    <a href="javascript:;">
                        <i class="fa fa-folder-open"></i> <span class="title">Room Offer </span><i class="icon-arrow"></i> <span class="arrow "></span>
                    </a>
                    <ul class="sub-menu">
                        <li>
                            <a href="#/add-room-offer">Add Room Offer <i class="icon-arrow"></i></a>
                        </li>
                    </ul>
                </li>
                <li>
    ...
    <div class="navbar-content">
        ...
        <div class="main-navigation left-wrapper transition-left">
            ...
            <ul class="main-navigation-menu">
                ...
                <li>
                    <a href="javascript:;" class="active">
                        <i class="fa fa-folder"></i> <span class="title">Room offer Benefit</span> <i class="icon-arrow"></i>
                    </a>
                    <ul class="sub-menu">
                        <li>
                            <a href="#/add-room-offer">
                              Add room offer <i class="icon-arrow"></i>
                            </a>
                            <ul class="sub-menu">
                                <li>
                                    <a href="#">
