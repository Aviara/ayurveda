            ...
            <div class="container">
                ...
                <div class="toolbar row">
                    <div class="col-sm-6 hidden-xs">
                        <div class="page-header">
                            <h1>Maps <small>google map samples</small></h1>
                        </div>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="panel panel-white">
                            <div class="panel-heading">
                                <h4 class="panel-title">Street <span class="text-bold">View</span></h4>
                                <div class="panel-tools">										
                                    <div class="dropdown">
                                        <a data-toggle="dropdown" class="btn btn-xs dropdown-toggle btn-transparent-grey">
                                            <i class="fa fa-cog"></i>
                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <div class="panel panel-white">
                            <div class="panel-heading">
                                <h4 class="panel-title">Search <span class="text-bold">Address</span></h4>
                                <div class="panel-tools">										
                                    <div class="dropdown">
                                        <a data-toggle="dropdown" class="btn btn-xs dropdown-toggle btn-transparent-grey">
                                            <i class="fa fa-cog"></i>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="panel panel-white">
                            <div class="panel-heading">
                                <h4 class="panel-title">Interacting</h4>								
                                <div class="panel-tools">										
                                    <div class="dropdown">
                                        <a data-toggle="dropdown" class="btn btn-xs dropdown-toggle btn-transparent-grey">
                                            <i class="fa fa-cog"></i>
