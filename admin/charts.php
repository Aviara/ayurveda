    ...
    <div class="main-container inner">
        ...
        <div class="main-content">
            ...
            <div class="container">
                ...
                <div class="toolbar row">
                    <div class="col-sm-6 hidden-xs">
                        <div class="page-header">
                            <h1>Charts <small>charts &amp; graphs</small></h1>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <!-- start: SCATTER / BUBBLE CHART -->
                        <div class="panel panel-white">
                            <div class="panel-heading">
                                <h4 class="panel-title">Scatter / Bubble <span class="text-bold">Chart</span></h4>
                                <div class="panel-tools">										
                                    <div class="dropdown">
                                        <a data-toggle="dropdown" class="btn btn-xs dropdown-toggle btn-transparent-grey">
                                            <i class="fa fa-cog"></i>
                            ...
                            <div class="panel-body">
                                <div id="demo-chart-2" class="height-300">
                                    <svg></svg>
                                </div>
                            </div>
                        </div>
                        <!-- end: SCATTER / BUBBLE CHART -->
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="panel panel-white">
                            <div class="panel-heading">
                                <h4 class="panel-title">Stacked Area <span class="text-bold">Chart</span></h4>
                                <div class="panel-tools">										
                                    <div class="dropdown">
                                        <a data-toggle="dropdown" class="btn btn-xs dropdown-toggle btn-transparent-grey">
                                            <i class="fa fa-cog"></i>
                            ...
                            <div class="panel-body">
                                <div id="demo-chart-3" class="height-300">
                                    <svg></svg>
                                </div>
                            </div>
                        </div>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <!-- start: MULTI-BAR CHART -->
                        <div class="panel panel-white">
                            <div class="panel-heading">
                                <h4 class="panel-title">Stacked/Grouped <span class="text-bold">Multi-Bar</span> Chart</h4>
                                <div class="panel-tools">										
                                    <div class="dropdown">
                                        <a data-toggle="dropdown" class="btn btn-xs dropdown-toggle btn-transparent-grey">
                                            <i class="fa fa-cog"></i>
                            ...
                            <div class="panel-body">
                                <div id="demo-chart-5" class="height-300">
                                    <svg></svg>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-md-6">
                        <!-- start: LINE PLUS BAR CHART -->
                        <div class="panel panel-white">
                            <div class="panel-heading">
                                <h4 class="panel-title">Line <span class="text-bold">Plus Bar</span> Chart</h4>
                                <div class="panel-tools">										
                                    <div class="dropdown">
                                        <a data-toggle="dropdown" class="btn btn-xs dropdown-toggle btn-transparent-grey">
                                            <i class="fa fa-cog"></i>
                            ...
                            <div class="panel-body">
                                <div id="demo-chart-6" class="height-300">
                                    <svg></svg>
                                </div>
                            </div>
                        </div>
                        <!-- end: LINE PLUS BAR CHART -->
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-6">
                        <!-- start: CUMULATIVE LINE CHART -->
                        <div class="panel panel-white">
                            <div class="panel-heading">
                                <h4 class="panel-title">Cumulative Line <span class="text-bold">Chart</span></h4>
                                <div class="panel-tools">										
                                    <div class="dropdown">
                                        <a data-toggle="dropdown" class="btn btn-xs dropdown-toggle btn-transparent-grey">
                                            <i class="fa fa-cog"></i>
                            ...
                            <div class="panel-body">
                                <div id="demo-chart-7" class="height-300">
                                    <svg></svg>
                                </div>
                            </div>
                        </div>
                        <!-- end: CUMULATIVE LINE CHART -->
                    </div>
                    <div class="col-md-6">
                        <!-- start: VIEW FINDER -->
                        <div class="panel panel-white">
                            <div class="panel-heading">
                                <h4 class="panel-title">Line Chart with <span class="text-bold">View</span> Finder</h4>
                                <div class="panel-tools">										
                                    <div class="dropdown">
                                        <a data-toggle="dropdown" class="btn btn-xs dropdown-toggle btn-transparent-grey">
                                            <i class="fa fa-cog"></i>
                            ...
                            <div class="panel-body">
                                <div id="demo-chart-8" class="height-300">
                                    <svg></svg>
                                </div>
                            </div>
                        </div>
