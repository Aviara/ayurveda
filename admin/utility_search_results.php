                ...
                <div class="toolbar row">
                    <div class="col-sm-6 hidden-xs">
                        <div class="page-header">
                            <h1>Search Results <small>subtitle here</small></h1>
                        </div>
                    </div>
                        ...
                        <div class="panel panel-white">
                            <div class="panel-body">
                                ...
                                <div class="search-classic">
                                    ...
                                    <h3>Search results for 'Rapido'</h3>
                                    <hr>
                                    <div class="search-result">
                                        <h4>
                                            <a href="#">
                                                Rapido - Responsive Admin Template
                                            </a></h4>
                                        <a href="#">
                                            http://www.apple.com
                                        </a>
                                    ...
                                    <div class="search-result">
                                        <h4>
                                            <a href="#">
                                                Rapido - Responsive Admin Dashboard Template
                                            </a></h4>
                                        <a href="#">
                                            http://www.apple.com
                                        </a>
                                    ...
                                    <hr>
                                    <ol class="pagination pagination-green text-center pull-right">
