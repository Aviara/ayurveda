                ...
                <div class="toolbar row">
                    <div class="col-sm-6 hidden-xs">
                        <div class="page-header">
                            <h1>X-editable <small>In-place editing</small></h1>
                        </div>
                    </div>
                        ...
                        <div class="panel panel-white">
                            ...
                            <div class="panel-body">
                                ...
                                <div class="pull-right space15">
                                    <label class="inline-block margin-right-30">
                                        <input type="checkbox" id="autoopen" class="grey">
                                ...
                                <table id="user" class="table table-bordered table-striped">
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div data-original-title="Enter notes" data-toggle="manual" data-type="wysihtml5" data-pk="1" id="note" class="editable" tabindex="-1">
                                                    <h3>WYSIWYG</h3>
