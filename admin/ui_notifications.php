                ...
                <div class="toolbar row">
                    <div class="col-sm-6 hidden-xs">
                        <div class="page-header">
                            <h1>Notifications <small>Toastr notifications &amp; SweetAlert</small></h1>
                        </div>
                    </div>
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <div class="form-group">
                                            <div class="checkbox-list">
                                                <div class="checkbox">
                                                    <label>
                                                        <input type="checkbox" value="" class="grey" id="closeButton">
                                                        Close Button
                                                    </label>
                                                </div>
                                                <div class="checkbox">
                                                    <label>
                                                        <input type="checkbox" value="" class="grey" id="addBehaviorOnToastClick">
                                    ...
                                    <div class="col-md-3">
                                        <div id="toastTypeGroup" class="form-group">
                                            ...
                                            <div class="radio-list">
                                                <div class="radio">
                                                    <label>
                                                        <input type="radio" value="success" name="toasts" class="grey" checked="checked">
                                                        Success
                                                    </label>
                                                </div>
                                                <div class="radio">
                                                    <label>
                                                        <input type="radio" value="info" name="toasts" class="grey">
                                                        Info
                                                    </label>
                                                </div>
                                                <div class="radio">
                                                    <label>
                                                        <input type="radio" value="warning" name="toasts" class="grey">
                                                        Warning
                                                    </label>
                                                </div>
                                                <div class="radio">
                                                    <label>
                                                        <input type="radio" value="error" name="toasts" class="grey">
                                                        Error
                                                    </label>
                                                </div>
                                            </div>
                                        ...
                                        <div id="positionGroup" class="form-group">
                                            ...
                                            <div class="radio-list">
                                                <div class="radio">
                                                    <label>
                                                        <input type="radio" value="toast-top-right" name="positions" class="grey" checked="checked">
                                                        Top Right
                                                    </label>
                                                </div>
                                                <div class="radio">
                                                    <label>
                                                        <input type="radio" value="toast-bottom-right" name="positions" class="grey">
                                                        Bottom Right
                                                    </label>
                                                </div>
                                                <div class="radio">
                                                    <label>
                                                        <input type="radio" value="toast-bottom-left" name="positions" class="grey">
                                                        Bottom Left
                                                    </label>
                                                </div>
                                                <div class="radio">
                                                    <label>
                                                        <input type="radio" value="toast-top-left" name="positions" class="grey">
                                                        Top Left
                                                    </label>
                                                </div>
                                                <div class="radio">
                                                    <label>
                                                        <input type="radio" value="toast-top-full-width" name="positions" class="grey">
                                                        Top Full Width
                                                    </label>
                                                </div>
                                                <div class="radio">
                                                    <label>
                                                        <input type="radio" value="toast-bottom-full-width" name="positions" class="grey">
                                                        Bottom Full Width
                                                    </label>
                                                </div>
                                            </div>
